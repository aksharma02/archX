    ...
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full right-0 w-48 bg-white shadow-lg rounded-lg py-2 hidden group-hover:block">
                {['Residential', 'Commercial', 'Sustainable', 'Urban Planning'].map(category => (
                  <a key={category} href={`#${category.toLowerCase()}`} className="block px-4 py-2 text-gray-700 hover:bg-gray-100">{category}</a>
                ))}
              </div>
            </div>
      ...
      <section className="relative bg-blue-900 text-white py-20">
        <div className="absolute inset-0 overflow-hidden">
          <img src="https://images.unsplash.com/photo-1486325212027-8081e485255e?auto=format&fit=crop&q=80" alt="Architecture background" className="w-full h-full object-cover opacity-20" />
        </div>
      ...
      <section className="py-16 bg-gray-50 max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          {[{ icon: Building, title: 'Visit Us', info: '123 Architecture Ave, NY 10001' },
            ...
            { icon: Phone, title: 'Call Us', info: '+1 (555) 123-4567' }].map(({ icon: Icon, title, info }) => (
