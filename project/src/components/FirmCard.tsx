  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        ...
        <button className="w-full mt-2 flex items-center justify-center gap-2 px-4 py-2 bg-blue-500 text-white rounded-lg group-hover:bg-blue-600 shadow-md hover:shadow-lg transition-all">
          View Profile
